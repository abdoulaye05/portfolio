            ...
            <>
                ...
                <section className={styles.listContainer}>
                    ...
                    <ul className={styles.list}>
                        {worksData.map((w) => {
                            let to = `/works/${w.id}`;
                            if (w.title.toLowerCase() === 'kasa') to = '/kasa';
                            if (w.title.toLowerCase().includes('sophie')) to = '/sophiebluel';
                            // Ajoute ici d'autres conditions pour d'autres projets spécifiques
                            return (
